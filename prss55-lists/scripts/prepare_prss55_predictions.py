...
def main():
    ...
    ap.add_argument("--p1-offset", type=int, choices=range(1, 8), default=4,
                    help="Known P1 position within each 8-mer (default: 4); omit only when the cleavage bond is unresolved")
    args = ap.parse_args()
